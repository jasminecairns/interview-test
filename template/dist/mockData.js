...
const csvPath = path.resolve(new URL('.', import.meta.url).pathname, 'Expanded_Diary_Entries.csv');
let raw = '';
try {
...
export const mockVoiceEntries = Array.from({ length: rowCount }).map((_, i) => buildEntry(i));
